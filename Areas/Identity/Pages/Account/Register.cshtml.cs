...
namespace Fivesemtest.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            Fivesemtest.Models.FivesemestercswrkContext context,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToPage("/Customer/Create", new { userId = user.Id });
                    }
                    else if (Input.Role == "performer")
                    {
                        return RedirectToPage("/Performer/Create", new { userId = user.Id });
                    }
                }
